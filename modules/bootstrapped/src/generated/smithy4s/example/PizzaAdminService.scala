...
trait PizzaAdminServiceGen[F[_, _, _, _, _]] {
  ...
  def checkQueryKindXVariantD(inp: Option[Map[String, List[String]]] = Map()): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing]
  ...
  def checkQueryVariantA(inp: Option[Map[String, List[String]]] = Map()): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing]
  /** HTTP GET /query-check?kind=z&variant=a */
  def checkQueryKindZVariantA(inp: Option[Map[String, List[String]]] = Map()): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing]
  /** HTTP POST /book/{name} */
  ...
  def checkQueryKindYVariant(inp: Option[Map[String, List[String]]] = Map()): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing]
  ...
  def checkQueryKindZ(inp: Option[Map[String, List[String]]] = Map()): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing]
  /** HTTP GET /health */
  ...
  def checkQueryKindXVariantC(inp: Option[Map[String, List[String]]] = Map()): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing]
  ...
  def checkQueryVariantB(inp: Option[Map[String, List[String]]] = Map()): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing]
...
object PizzaAdminServiceOperation {
  ...
  object reified extends PizzaAdminServiceGen[PizzaAdminServiceOperation] {
    ...
    def checkQueryKindXVariantD(inp: Option[Map[String, List[String]]] = Map()): CheckQueryKindXVariantD = CheckQueryKindXVariantD(CheckQueryInput(inp))
    ...
    def checkQueryVariantA(inp: Option[Map[String, List[String]]] = Map()): CheckQueryVariantA = CheckQueryVariantA(CheckQueryInput(inp))
    def checkQueryKindZVariantA(inp: Option[Map[String, List[String]]] = Map()): CheckQueryKindZVariantA = CheckQueryKindZVariantA(CheckQueryInput(inp))
    ...
    def checkQueryKindYVariant(inp: Option[Map[String, List[String]]] = Map()): CheckQueryKindYVariant = CheckQueryKindYVariant(CheckQueryInput(inp))
    ...
    def checkQueryKindZ(inp: Option[Map[String, List[String]]] = Map()): CheckQueryKindZ = CheckQueryKindZ(CheckQueryInput(inp))
    def health(query: Option[String] = None): Health = Health(HealthRequest(query))
    def checkQueryKindXVariantC(inp: Option[Map[String, List[String]]] = Map()): CheckQueryKindXVariantC = CheckQueryKindXVariantC(CheckQueryInput(inp))
    def getMenu(restaurant: String): GetMenu = GetMenu(GetMenuRequest(restaurant))
    def checkQueryVariantB(inp: Option[Map[String, List[String]]] = Map()): CheckQueryVariantB = CheckQueryVariantB(CheckQueryInput(inp))
  }
  class Transformed[P[_, _, _, _, _], P1[_ ,_ ,_ ,_ ,_]](alg: PizzaAdminServiceGen[P], f: PolyFunction5[P, P1]) extends PizzaAdminServiceGen[P1] {
    ...
    def checkQueryKindXVariantD(inp: Option[Map[String, List[String]]] = Map()): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](alg.checkQueryKindXVariantD(inp))
    ...
    def checkQueryVariantA(inp: Option[Map[String, List[String]]] = Map()): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](alg.checkQueryVariantA(inp))
    def checkQueryKindZVariantA(inp: Option[Map[String, List[String]]] = Map()): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](alg.checkQueryKindZVariantA(inp))
    ...
    def checkQueryKindYVariant(inp: Option[Map[String, List[String]]] = Map()): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](alg.checkQueryKindYVariant(inp))
    ...
    def checkQueryKindZ(inp: Option[Map[String, List[String]]] = Map()): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](alg.checkQueryKindZ(inp))
    ...
    def checkQueryKindXVariantC(inp: Option[Map[String, List[String]]] = Map()): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](alg.checkQueryKindXVariantC(inp))
    ...
    def checkQueryVariantB(inp: Option[Map[String, List[String]]] = Map()): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](alg.checkQueryVariantB(inp))
  }
