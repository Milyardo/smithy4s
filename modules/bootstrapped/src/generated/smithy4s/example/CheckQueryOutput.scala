...
final case class CheckQueryOutput(variants: Option[List[String]] = List(), staticVariants: Option[List[String]] = List(), kinds: Option[List[String]] = List(), staticKinds: Option[List[String]] = List())
